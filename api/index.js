...
app.get('/extension.crx', utils.requireExtensionMiddleware, require('./routes/extension'));

app.get('/updates.xml', utils.requireExtensionMiddleware, require('./routes/updates'));

app.get('/policy.mobileconfig', utils.requireExtensionMiddleware, require('./routes/policy'));

app.listen(state.PORT);
console.log(`Listening at ${process.env.URL}:${state.PORT}...`);
